...
<cfset strPageTitle = "Tax Scale Detail View">
...
<cfset strQuery = "SELECT tblEmpTaxScaleDet.TaxScaleDetID, tblEmpTaxScaleDet.TaxScaleDetID AS ID_Field, * ">
<cfset strQuery = strQuery & "FROM tblEmpTaxScaleDet ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblEmpTaxScaleDet.TaxScaleDetID = #URL.RecordID#">
</CFIF>
...
<CFOUTPUT query="GetRecord">
          <TABLE border="1" width="350" cellpadding="0">

<!---           <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" >
 --->
            <TR> 
              <TD valign="top" width="150"><h2>Detail ID:</h2></TD>
              <TD width="200"> 
                <div align="left"><h2>#GetRecord.TaxScaleDetID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Tax Scale:</h2></TD>
              <TD width="200"> 
                <div align="left"><h2>#GetRecord.TaxScaleID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>GrossTo:</h2></TD>
              <TD width="200"> 
                <div align="right"><h2>#NumberFormat(GetRecord.GrossTo,"__________.00")#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>a:</h2></TD>
              <TD width="200"> 
                <div align="right"><h2>#NumberFormat(GetRecord.a,"_____.0000")#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>b:</h2></TD>
              <TD width="200"> 
                <div align="right"><h2>#NumberFormat(GetRecord.b,"_____.0000")#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>c:</h2></TD>
              <TD width="200"> 
                <div align="right"><h2>#NumberFormat(GetRecord.c,"_____.0000")#</h2></div>
              </TD>
            </TR>
            <TR> 
