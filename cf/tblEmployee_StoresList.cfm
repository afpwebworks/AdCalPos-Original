<cfset strPageTitle = "Assign Stores to Employees">
...
<cfscript>
	...
	Employees = UsersDAO.getAllUsers();
</cfscript>
<HTML>
<HEAD>
        ...
        <table id="id2" class="tablesorter">
          ...
          <tbody>
            <cfloop query="Employees">
              <cfoutput>
                <tr>
                  <td><a href="tblEmployee_StoresAction.cfm?cfgridkey=#Employees.employeeid#">#Employees.employeeid#</a></td>
                  <td>#Employees.UserFullName#</td>
                  <td>#Employees.StoreName#</td>
                </tr>
              </cfoutput>
            </cfloop>
          </tbody>
