...
<cfset local.page="PayrollSelectReport.cfm">
...
<br>
<br>
<FORM action="PayrollSelectReportAction.cfm" id="<cfoutput>#local.formName#</cfoutput>" method="post" name="<cfoutput>#local.formName#</cfoutput>" onsubmit="return submitCheck('<cfoutput>#local.formName#</cfoutput>');">
