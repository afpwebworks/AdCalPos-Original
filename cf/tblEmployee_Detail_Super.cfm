...
<cfset strPageTitle = "Super Detail">
		...
		<table width="100%">
		  <tr> 
		    <td width="150" align="Left"><font face="Tahoma" color="FFFFFF" size="4">Week Ending</font></td>
		 	<td width="150" align="right"><font face="Tahoma" color="FFFFFF" size="4">Super Amount</font></td>
		  </tr>
		  ...
		  <tr> 
		    ...
		    <td width="150" align="right"><font face="Tahoma" color="FFFFFF" size="3">#NumberFormat(GetDetail.SuperAccumulated,"_____.99")#</font></td>
		  </tr>
		  </cfoutput>	
		  <cfoutput>
		  <tr> 
