...
<cfset strPageTitle = "Award Rates">
...
<cfset strQuery = strQuery & "ORDER BY tblEmpAwardPayRates.EmpStatusID, tblEmpAwardPayRates.Age ">
      ...
      <table id="id2" class="tablesorter">
        ...
        <tbody>
        	<cfloop query="getrecord"><cfoutput>
            	<tr>
                	<td><a href="tblEmpAwardPayRates_RecordActionGrid.cfm?cfgridkey=#getrecord.awardid#">#getrecord.awardid#</a></td>
                	<td>#getrecord.Age#</td>
                	<td>#numberformat(getrecord.HourlyPay, "_____.0000")#</td>
