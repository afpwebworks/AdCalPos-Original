...
<cfset strPageTitle = "Wastage / Transfer">
...
<table width="100%" border="0">
  ...
  <cfoutput query = "GetRecord">
          ...
          <tr> 
            <td>
				<h4><a href="StocktakeAdjust_RecordEdit.cfm?RecordID=#GetRecord.ID#"><h3>Wastage</h3></a></h4>
			</td>
            <td>
				<h4><a href="StocktakeAdjust_RecordEdit.cfm?RecordID=#GetRecord.ID#"><h3>Transfer</h3></a></h4>
			</td>
