...
<cfset local.formName="frmCheckCredit">
<cfset local.page="CheckCredits.cfm">
...
<br>
<br>
<FORM action="CheckCreditsList.cfm" id="frmCheckCredit" method="post" name="frmCheckCredit" onSubmit="return submitCheck('<cfoutput>#local.formName#</cfoutput>');">
<INPUT TYPE="hidden" NAME="StoreID" VALUE="<cfoutput>#lngStoreID#</cfoutput>">
  ...
  <tr>
    <td>
      <div align="center">
	    ...
	    <p><input type="submit" name="CreditSummary" value=" See Credit Summary  "></p>
	  <p>&nbsp;</p>
	  </form>
	  </div>
    </td>
