...
<cfset strPageTitle = "Price Formula View">
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              <TD valign="top" width="200"><h2>Formula ID:</h2></TD>
              <TD width="350"> 
                <div align="right"><h2>#GetRecord.PriceFormulaID#</h2></div>
              </TD>
            </TR>
			
            <TR> 
              <TD valign="top" width="200"><h2>PLU:</h2></TD>
              <TD width="350"> 
                <div align="left"><h2>#GetRecord.PartNo#</h2></div>
              </TD>
            </TR>
			
            <TR> 
              <TD valign="top" width="200"><h2>Description:</h2></TD>
              <TD width="350"> 
            ...
            <TR> 
              <TD valign="top" width="200"><h2>Wholesale From:</h2></TD>
              <TD width="350"> 
                <div align="right"><h2>#NumberFormat(GetRecord.PriceFrom,"_____.99")#</h2></div>
              </TD>
            </TR>
			
            <TR> 
              <TD valign="top" width="200"><h2>Wholesale To:</h2></TD>
              <TD width="350"> 
                <div align="right"><h2>#NumberFormat(GetRecord.PriceTo,"_____.99")#</h2></div>
              </TD>
            </TR>
			
            <TR> 
              <TD valign="top" width="200"><h2>Max Retail:</h2></TD>
              <TD width="350"> 
                <div align="right"><h2>#NumberFormat(GetRecord.MaxRetail,"_____.99")#</h2></div>
              </TD>
            </TR>
			
            <TR> 
              <TD valign="top" width="200"><h2>GP %:</h2></TD>
              <TD width="350"> 
                <div align="right"><h2>#NumberFormat(GetRecord.GP,"___.99")#&nbsp</h2></div>
              </TD>
            </TR>
			
            <TR> 
              <TD valign="top" width="200"><h2>Date Entered:</h2></TD>
              <TD width="350"> 
