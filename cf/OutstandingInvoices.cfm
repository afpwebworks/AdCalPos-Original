  ...
  <tr>
    <td>
      <div align="center">&nbsp; 
		...
		<!--- get the lines --->
		<cfset strQuery = "SELECT qryInvoiceDetailTotalPayApplication.InvoiceID, qryInvoiceDetailTotalPayApplication.StoreID, qryInvoiceDetailTotalPayApplication.InvoiceDate, qryInvoiceDetailTotalPayApplication.GrandTotalIncGST, qryInvoiceDetailTotalPayApplication.AmountRemaining, qryInvoiceDetailTotalPayApplication.AmountApplied,">
		<cfset strQuery=strQuery & "substring(qryInvoiceDetailTotalPayApplication.InvoiceDate,5,4)+substring(qryInvoiceDetailTotalPayApplication.InvoiceDate,3,2)+substring(qryInvoiceDetailTotalPayApplication.InvoiceDate,1,2) AS InvoiceDateTextFormat,qryInvoiceDetailTotalPayApplication.InvoiceDateFormatted ">
		...
		<cfset strQuery = strQuery & "ORDER BY qryInvoiceDetailTotalPayApplication.InvoiceDateTextFormat ASC">
