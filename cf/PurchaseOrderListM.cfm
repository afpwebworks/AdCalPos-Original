  ...
  <CFLOOP QUERY="GetDepartments"> 
    <cfset lngDeptNo = #GetDepartments.DeptNo# >
	   ...
	   <tr> 
          ...
          <td height="40" bgcolor="#GetDepartments.backGroundColor#" width="119"> 
          ...
          <td height="40" bgcolor="#GetDepartments.backGroundColor#" width="74"> 
...
<!--- 	    <td width="117" bgcolor="3366FF"><font size="2" face="Tahoma"> 
 ...
 --->	    
          <td width="119" bgcolor="000099"><font size="2" face="Tahoma" font color="#strFontColor#"> 
            <div align="center">#GetRecord.PartNo#</div>
          </font></td>
...
<!--- 
 ...
 --->
    	  ...
    	  <td width="196"><font size="2" face="Tahoma" font color="#strFontColor#"> 
            <div align="center">#GetRecord.OrderingUnitMinOrder#</div></font></td>
