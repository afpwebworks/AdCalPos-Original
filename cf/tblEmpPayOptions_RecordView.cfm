...
<cfset strPageTitle = "Pay Options View">
...
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblEmpPayOptions.ID = #URL.RecordID#">
</CFIF>
...
<!---           <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" >
 --->
            <TR> 
              ...
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.ID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>SuperRate:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.SuperRate,"_____.0000")#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>HolidayPay:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.HolidayPay,"_____.0000")#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>HolidayLoading:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.HolidayLoading,"_____.0000")#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>SickLeaveYr1:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.SickLeaveYr1,"_____.0000")#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>SickLeave:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.SickLeave,"_____.0000")#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>WorkersComp:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.WorkersComp,"_____.0000")#</h2></div>
              </TD>
            </TR>
