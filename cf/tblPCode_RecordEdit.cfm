...
<cfset strPageTitle = "PCode Description Add/Edit">
...
<CFSET FormFieldList = "PCodeDescription">
...
<CFIF ParameterExists(URL.RecordID)>
    ...
    <!--- <CFQUERY  DBTYPE="OLEDB" PROVIDER="#AppProvider#" dataSource="#AppCostiDB1#" PROVIDERDSN="#AppCostiDB1#" USERNAME="admin" name="GetRecord"  maxRows=1> --->
		SELECT PCodeID, PCodeDescription, PCodeID AS ID_Field
		FROM tblPCodes
		<CFIF ParameterExists(URL.RecordID)>
		WHERE PCodeID = #URL.RecordID#
		</CFIF>
	</CFQUERY>

			<CFSET PCodeID_Value = #GetRecord.PCodeID#>
				
			<CFSET PCodeDescription_Value = #GetRecord.PCodeDescription#>
			
<CFELSE>
			<CFSET PCodeID_Value = ''>
				
			<CFSET PCodeDescription_Value = ''>
...
<FORM action="tblPCode_RecordAction.cfm" method="post">
...
<table width="100%">
  <tr valign="middle"> 
    ...
    <td width="25%"> 
      <div align="right"><a href="tblPCode_RecordList.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
    </td>
  </tr>
</table>
<br>
...
<CFIF ParameterExists(URL.RecordID)>
	...
	<INPUT type="hidden" name="PCodeID" value="#URL.RecordID#">
</CFIF>
            ...
            <TABLE width="400" border="1" cellpadding="2">
	          ...
	          <TR> 
                ...
                <TD> 
                  <font face="Tahoma" size="4" color="FFFFFF">#PCodeID_Value#</font>
                </TD>
              </TR>
			  </CFIF>
              ...
              <TR> 
                <TD valign="top" width="250"><b><font face="Tahoma" size="4" color="FFFFFF"> 
                  PCode Description: </font></b></TD>
                <TD> 
                  <INPUT type="text" name="PCodeDescription" value="#PCodeDescription_Value#" size="35" maxLength="15">
                  <INPUT type="hidden" name="PCodeDescription_required" value="Please type a PCode description.">				
                </TD>
              </TR>
