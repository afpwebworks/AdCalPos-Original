...
<cfset local.formName="frmReportFinancialAction">
<cfset local.page="ReportFinancial1Action.cfm">
...
<cfset strPageTitle = "Report " + #startDate# + #endDate>
...
<br>
<br>
<FORM action="RosterAction.cfm" id="<cfoutput>#local.formName#</cfoutput>" method="post" name="<cfoutput>#local.formName#</cfoutput>" onsubmit="return submitCheck('<cfoutput>#local.formName#</cfoutput>');">
