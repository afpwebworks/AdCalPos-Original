...
<cfset local.page="PayrollSelectReportTax.cfm">

<cfset strPageTitle = "Pay Tax">
...
<br>
<br>
<FORM action="PayrollSelectReportActionTax.cfm" id="<cfoutput>#local.formName#</cfoutput>" method="post" name="<cfoutput>#local.formName#</cfoutput>" onsubmit="return submitCheck('<cfoutput>#local.formName#</cfoutput>');">
  ...
  <tr>
    <td>
      <div align="center">
	    ...
	    <p><input type="submit" name="AmountToPay" value=" See Tax Summary  "></p>
	  <p>&nbsp;</p>
	  </form>
	  </div>
    </td>
