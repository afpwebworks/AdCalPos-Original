...
<CFIF ParameterExists(Form.SubmitReport)>
		<CFLOCATION url="TransferReport.cfm?cmbDeptNo=0">
</cfif> 
...
<FORM action="TransferActionCheck.cfm" method="post">
...
<!---             <td><div align="right"><h4>#numberformat(GetRecord.QtyOnHand,"_____.00")#&nbsp;</h4></div></td>			
 --->			<td>
				<div align="center"><input type="text" name="Dept_#lngGlobalDepartment#_Value_Line_#lngGlobalRecordNumber#" maxlength="10" size = "10" value="#numberformat(GetRecord.TeansferQty,"______.000")#"></div></font>
			...
			<td>
				<div align="center"><input type="text" name="Dept_#lngGlobalDepartment#_Plu_Line_#lngGlobalRecordNumber#" maxlength="16" size = "20" value="#GetRecord.TransferToPlu#"></div></font>
			</td>
          </tr>
  </cfoutput>
