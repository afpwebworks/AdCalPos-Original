...
<cfset strPageTitle = "Saturday Casual Rates View">
...
<cfset strQuery = "SELECT tblEmpCasualRatesSat.ID, tblEmpCasualRatesSat.ID AS ID_Field, * ">
<cfset strQuery = strQuery & "FROM tblEmpCasualRatesSat ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblEmpCasualRatesSat.ID = #URL.RecordID#">
</CFIF>
...
<CFOUTPUT query="GetRecord">
          <TABLE border="1" width="450" cellpadding="2">
            ...
            <TR> 
              <TD valign="top" width="150"><h2>Age:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Age#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>ShiftMinsFrom:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#GetRecord.ShiftMinsFrom#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>ShiftMinsTo:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#GetRecord.ShiftMinsTo#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>ShiftAllowance:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.ShiftAllowance,"_____.0000")#</h2></div>
              </TD>
            </TR>
            <TR> 
