...
<cfset strPageTitle = "Stocktake Variance Report">
...
<table width="100%" border="0">
  ...
  <CFLOOP QUERY="GetDepartments"> 
    ...
    <cfset lngDeptNo = #GetDepartments.DeptNo# >
	   <cfoutput>
          <tr> 
            <td colspan="7"><h3>#GetDepartments.Dept#</h3></td>
          </tr>
          <tr> 
            <td><h4>Plu</h4></td>
            <td><h4>Description</h4></td>
            <td><div align="center"><h4>Unit</h4></div></td>
            <td><div align="right"><h4>Freezer</h4></div></td>
            <td><div align="right"><h4>Coolroom</h4></div></td>
            <td><div align="right"><h4>Display</h4></div></td>
			<td><div align="right"><h4>Total</h4></div></td>
            <!--- <td><div align="right"><h4>Variance</h4></div></td> --->
          </tr>
  ...
  <cfoutput query = "GetRecord">
          ...
          <tr> 
            <td>
				<h4><a href="StocktakeAdjust_RecordEdit.cfm?RecordID=#GetRecord.ID#"><font color="yellow"><b>#GetRecord.PartNo#</b></font></a></h4>
			...
			<td>
				<div align="right"><h4>#GetRecord.Freezer_QtyOnHand#</h4></div></font>
			</td>
			<td>
				<div align="right"><h4>#GetRecord.CoolRoom_QtyOnHand#</h4></div></font>
			</td>
			<td>
				<div align="right"><h4>#GetRecord.Display_QtyOnHand#</h4></div></font>
			</td>
