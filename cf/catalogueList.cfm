...
<cfset strPageTitle = "Product Catalogue">

<!--- get the Departments ---><!--- Count(tblStockMaster.PartNo) AS CountOfPartNo, --->
<cfset strQuery = "SELECT distinct tblStockDept.Dept, tblStockDept.DeptNo ">
...
<!--- <cfset strQuery = strQuery & "GROUP BY tblStockDept.Dept, tblStockDept.DeptNo, SupplyUnit, OrderingUnit, 
		PCode, minOrderQty, ThreeHRebateVal, typeID "> --->
...
<table width="100%">
  <tr valign="middle"> 
    ...
    <td width="25%"> 
      <div align="right"><a href="catalogue.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
    </td>
  </tr>
</table>
<br>
...
<table width="100%" border="0">
    ...
    <cfset lngDeptNo = #GetDepartments.DeptNo# >
	   <cfoutput>
          ...
          <tr> 
			...
			<td><h4>Supply Unit</h4></td>
            <td><h4>Ordering Unit</h4></td>
            <td><h4>P Code</h4></td>
            <td><h4>Min Order Qty</h4></td>
            <td><h4>Three H <br/>Rebate</h4></td>
            <td><h4>Type ID</h4></td>
          </tr>
  ...
  <cfoutput query = "GetRecord">
          <tr> 
            ...
            <td><div align="right"><h4>#GetRecord.OrderingUnit#&nbsp;</h4></div></td>
            <td><div align="right"><h4>#GetRecord.PCode#&nbsp;</h4></div></td>
            <td><div align="right"><h4>#GetRecord.minOrderQty#&nbsp;</h4></div></td>
            <td><div align="right"><h4>#numberformat(GetRecord.ThreeHRebateVal,"_____.000")#&nbsp;</h4></div></td>
			<td><div align="right"><h4>#GetRecord.typeID#&nbsp;</h4></div></td>
          </tr>
  </cfoutput>
