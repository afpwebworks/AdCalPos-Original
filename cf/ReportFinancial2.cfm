...
<cfset local.formName="frmReportFinancial2">
<cfset local.page="ReportFinancial2.cfm">
...
<br>
<br>
<FORM action="ReportFinancial2REP.cfm" id="frmReportFinancial2" method="post" name="frmReportFinancial2" onsubmit="return submitCheck('<cfoutput>#local.formName#</cfoutput>');">
  ...
  <tr>
    <td>
      <div align="center">
	    ...
	    <p><input type="submit" name="AmountToPay" value=" Report  "></p>
	  <p>&nbsp;</p>
	  </form>
	  </div>
    </td>
