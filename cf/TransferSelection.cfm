...
<cfset strPageTitle = "Transfer Entry">
...
<cfif (#strStocktakeHasBeenApplied# EQ 'Y')>
	<table width="100%" border="0">
	  <tr> 
    	<td width="7%">&nbsp;</td>
	    <td width="93%">
			<h3>You have already finished the stocktake for today</h3>
		</td>
	  </tr>
	  <tr> 
    	<td width="7%">&nbsp;</td>
	    <td width="93%">
			<h3>You can NOT enter transfer for today.</h3>
		</td>
	  </tr>
	</table>
<cfelse>
	      ...
	      <div align="center">
			...
			<FORM action="TransferBL.cfm" method="post">
				<select name="cmbDeptNo">
	    	      ...
	    	      &nbsp; 
    	    <p>
        	  <input type="submit" name="Submit" value="  Transfer Form  ">
	        </p>
<!---     	    
			<p>
        	  <input type="submit" name="SubmitReport" value="  Print Report ">
	        </p>
 --->			
			</form>
	      </div>
