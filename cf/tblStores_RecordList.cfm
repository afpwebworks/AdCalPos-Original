...
<cfset strPageTitle = "Store Details">
...
<cfset strQuery = "SELECT tblStores.StoreID , tblStores.StoreName ,  tblStores.DateEntered , tblStores.StoreID AS ID_Field ">
  ...
  <tr>
    <td>
      ...
      <tr>
       ...
       <tr>
       	<td><a href="tblStores_RecordActionGrid.cfm?CFGRIDKEY=#getrecord.storeid#">#getrecord.storeid#</a></td>
        <td>#getrecord.storename#</td>
       </tr>
       </cfoutput></cfloop>
       </tbody> 
 	  </div>
