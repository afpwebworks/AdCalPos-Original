...
<cfset strPageTitle = "Supplier Details View">
<!--- 
...
<cfset strQuery = "SELECT tblSupplier.SupplierID, *, tblSupplier.SupplierID AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblSupplier ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblSupplier.SupplierID = #URL.RecordID#">
</CFIF>
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="500" cellspacing="0" > --->
            ...
            <TR> 
              <TD valign="top" width="150"><h2>SupplierID:</h2></TD>
              <TD width="350"> 
                <div align="left"><h2>#GetRecord.SupplierID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Supplier Name:</h2></TD>
              <TD width="350"> 
                <div align="left"><h2>#GetRecord.SupplierName#</h2></div>
              </TD>
            </TR>
            ...
            <TR> 
              ...
              <TD width="350"> 
                <div align="right"><h2>#numberformat(GetRecord.AcctBalance,"999,999,999.99")#&nbsp;</h2></div>
              </TD>
            </TR>
            ...
            <TR> 
              ...
              <TD width="350"> 
                <div align="right"><h2>#numberformat(GetRecord.CreditLimit,"999,999,999")#&nbsp;</h2></div>
              </TD>
            </TR>
