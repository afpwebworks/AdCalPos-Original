...
<cfset strPageTitle = "Sick Hours Taken (Paid)">
		...
		<table width="100%">
		  <tr> 
		    <td width="150" align="Left"><font face="Tahoma" color="FFFFFF" size="4">Week Ending</font></td>
		 	<td width="150" align="right"><font face="Tahoma" color="FFFFFF" size="4">Paid Sick Hours Taken</font></td>
		  </tr>
		  <cfoutput query = "GetDetail">
		  	  <cfset dblTemp = #GetDetail.SickHrsCanBePaid#  >
