...
<cfset strPageTitle = "Employee Entitlement View">
...
<cfset strQuery = "SELECT tblEmpEntitlement.EntitleID, tblEmpEntitlement.EntitleID AS ID_Field, *  ">
<cfset strQuery = strQuery & "FROM tblEmpEntitlement ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblEmpEntitlement.EntitleID = #URL.RecordID#">
</CFIF>
...
<!---           <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" >
 --->
            <TR> 
              ...
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.EntitleID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Item:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Item#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Detail:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Detail#</h2></div>
              </TD>
            </TR>
			
            <TR> 
              <TD valign="top" width="150"><h2>Multiplier:</h2></TD>
              <TD width="300"> 
                <div align="right"><h2>#NumberFormat(GetRecord.Multiplier,"_____.000000")#</h2></div>
              </TD>
            </TR>
            <TR> 
