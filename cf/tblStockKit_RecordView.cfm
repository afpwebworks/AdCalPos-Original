...
<cfset strPageTitle = "Product Ratios View">
...
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblStockKit.KitID = #URL.RecordID#">
</CFIF>
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              <TD valign="top" width="250"><h2>KitID:</h2></TD>
              <TD width="200"> 
                <div align="right"><h2>#GetRecord.KitID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="250"><h2>Selling PLU No.:</h2></TD>
              <TD width="200"> 
                <div align="left"><h2>#GetRecord.PartNoSalePLU#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="250"><h2>Buying PLU No.:</h2></TD>
              <TD width="200"> 
                <div align="left"><h2>#GetRecord.PartNoBuyingPLU#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="250"><h2>Prepararation Code:</h2></TD>
              <TD width="200"> 
                <div align="left"><h2>#GetRecord.PrepCode#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="250"><h2>Ratio:</h2></TD>
              <TD width="200"> 
                <div align="right"><h2>#NumberFormat(GetRecord.Ratio,"999.000")#</h2></div>
              </TD>
            </TR>
