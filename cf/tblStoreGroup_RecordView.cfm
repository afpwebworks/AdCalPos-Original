...
<cfset strPageTitle = "Store Group View">
...
<cfset strQuery = "SELECT tblStoreGroup.StoreGroupID, tblStoreGroup.StoreGroup, tblStoreGroup.DateEntered, tblStoreGroup.StoreGroupID AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblStoreGroup ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblStoreGroup.StoreGroupID = #URL.RecordID#">
</CFIF>
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              <TD valign="top" width="150"><h2>Group ID:</h2></TD>
              <TD width="250"> 
                <div align="left"><h2>#GetRecord.StoreGroupID#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>Group Name:</h2></TD>
              <TD width="250"> 
                <div align="left"><h2>#GetRecord.StoreGroup#</h2></div>
              </TD>
            </TR>
