...
<cfset strPageTitle = "Ingredients View">
...
<table width="100%">
  <tr valign="middle"> 
    ...
    <td width="25%"> 
		<cfoutput>
      <div align="right"><a href="tblIngredientEdit.cfm?RecordID=#URL.SaleID#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
	  </cfoutput>
    </td>
  </tr>
</table>
...
<FORM action="tblIngredient_RecordAction.cfm" method="post">
	...
	<INPUT type="hidden" name="PartNum" value="#URL.SaleID#">
<table width="100%" border="0">
  <tr>
    <td> 
      <div align="center">
...
<CFOUTPUT query="GetRecord">
          <TABLE border="1" width="450" cellpadding="2">
            ...
            <TR> 
              <TD valign="top" width="150"><h2>Ingredients Desc</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Description#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Ingredients Qty</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#numberformat(GetRecord.qtyIngredient,"______.000")# #GetRecord.SupplyUnit# </h2></div>
              </TD>
            </TR>
