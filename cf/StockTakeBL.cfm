...
<CFelseIF ParameterExists(Form.StoreID)>
...
<cfif lngDeptNo LT 1>
	<cfset strQuery = strQuery & "WHERE (  ((tblStockMaster.PCode)=0) AND  ((tblStockMaster.SuppressStocktake)=0) AND ((tblStockMaster.NoLongerUsed)=0) AND ((tblStockMaster.PluType ='M') or (tblStockMaster.PluType ='N'))) ">
<cfelse>
	<cfset strQuery = strQuery & "WHERE (  ((tblStockMaster.PCode)=0) AND ((tblStockMaster.SuppressStocktake)=0) AND ((tblStockMaster.NoLongerUsed)=0) AND ((tblStockMaster.PluType ='M') or (tblStockMaster.PluType ='N'))  AND ((tblStockDept.DeptNo)= #lngDeptNo# ) ) ">
</cfif>
...
<table width="100%">
  <tr valign="middle"> 
    ...
    <td width="25%"> 
      <cfoutput>
	  <div align="right"><a href="StockTakeSelectionBL.cfm?sid=#lngStoreID#&eid=#lngEmployeeID#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
	  </cfoutput>
    </td>
  </tr>
  <tr> 
...
<FORM action="StockTakeActionBL.cfm" method="post">
    ...
    <cfset lngDeptNo = #GetDepartments.DeptNo# >
	   <cfoutput>
          ...
          <tr> 
            ...
            <td><h4>Unit</h4></td>
            <td><h4>Warehouse</h4></td>
            <td><h4>StoreRoom</h4></td>
            <td><h4>Display</h4></td>
			<td><h4>Total</h4></td>			
          </tr>
		...
		<cfset strQuery = strQuery & "WHERE ( ((qryStockValuationForStocktake.StoreID)=#lngStoreID#) AND  ((qryStockValuationForStocktake.StoreID)=#lngStoreID#) AND ((qryStockValuationForStocktake.DeptNo)=#lngDeptNo#)) ">
