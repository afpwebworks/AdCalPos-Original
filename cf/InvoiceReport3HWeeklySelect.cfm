...
<cfset local.formName="frmWeeklyInvoiceReport">
<cfset local.page="InvoiceReport3HWeeklySelect.cfm">
...
<table align="center" border="1" bordercolor="#4B4B4B" cellpadding="2" cellspacing="0">
	...
	<tr><!--- - create counters for the calendar - --->
		...
		<cfloop from="1" to="42" index="i">
			...
			<cfif local.dateCount LTE daysInMonth(local.cDate) AND dayOfWeek(createDate(year(local.cDate),month(local.cDate),local.dateCount)) EQ local.cCount>
				...
				<td align="center" class="normal_body"><a<cfif year(local.cDate) EQ year(now()) AND month(local.cDate) EQ month(now()) AND local.dateCount EQ day(now())> class="today"</cfif> href="InvoiceReport3HWeekly.cfm?date=<cfoutput>#year(local.cDate)##numberFormat(month(local.cDate),00)##numberFormat(local.dateCount,00)#</cfoutput>&amp;RequestTimeout=300"><cfoutput>#numberFormat(local.dateCount,99)#</cfoutput></a></td>
	...
	<tr>
		<td class="cal_days"><a href="InvoiceReport3HWeeklySelect.cfm?pos=bwd"><img src="../images/s.gif" width="5" height="1" alt="spacer" border="0" />&lt;<img src="../images/s.gif" width="5" height="1" alt="spacer" border="0" /></a></td>
		<td class="cal_days" colspan="5"><img src="../images/s.gif" width="1" height="1" alt="spacer" border="0" /></td>
		<td class="cal_days"><a href="InvoiceReport3HWeeklySelect.cfm?pos=fwd"><img src="../images/s.gif" width="5" height="1" alt="spacer" border="0" />&gt;<img src="../images/s.gif" width="5" height="1" alt="spacer" border="0" /></a></td>
	</tr>
</table>
</form>
</body>
