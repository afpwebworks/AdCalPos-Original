<cfset strPageTitle = "Public Holidays">
...
<cfset strQuery = "SELECT tblEmpPublicHol.PublicHolID , tblEmpPublicHol.PublicHolID AS ID_Field, case when Trading = 0 then 'No' else 'Yes' end AS ShopIsOpen,* ">
<cfset strQuery = strQuery & "FROM tblEmpPublicHol ">
<cfset strQuery = strQuery & "ORDER BY tblEmpPublicHol.PublicHolID">
        ...
        <table id="id2" class="tablesorter">
          ...
          <tbody>
            <cfloop query="getrecord">
              <cfoutput>
                <tr>
                  <td><a href="tblEmpPublicHol_RecordActionGrid.cfm?cfgridkey=#getrecord.PublicHolID#">#getrecord.PublicHolID#</a></td>
                  <td>#getrecord.Date#</td>
                  <td>#getrecord.Name#</td>
                  <td>#getrecord.ShopIsOpen#</td>
                </tr>
              </cfoutput>
            </cfloop>
          </tbody>
