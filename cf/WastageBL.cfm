...
<CFIF ParameterExists(Form.SubmitReport)>
		<CFLOCATION url="WastageReport.cfm?cmbDeptNo=0">
</cfif> 
...
<cfset strPageTitle = "Wastage">

<!--- Get the store name --->
<cfset strQuery = "Select * from tblStores ">
<cfset strQuery = strQuery & "Where StoreID = #lngStoreID#">
<CFQUERY name="GetStoreName"      datasource="#application.dsn#"        > <!--- <CFQUERY name="GetStoreName"      dataSource="#AppCostiDB1#"       USERNAME="admin"> --->
...
<table width="100%">
  <tr valign="middle"> 
    ...
    <td width="25%"> 
      <div align="right"><a href="WastageSelection.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
    </td>
  </tr>
  <tr> 
 	<td colspan="3"> 
...
<FORM action="WastageActionCheck.cfm" method="post">
...
<!---             <td><div align="right"><h4>On Hand</h4></div></td>
 --->
		...
		<cfset strQuery = strQuery & "qryStockValuationForStocktake.Wastage ">
		<cfset strQuery = strQuery & "FROM qryStockValuationForStocktake ">
		<cfset strQuery = strQuery & "WHERE ( ( qryStockValuationForStocktake.QtyOnHand > 0 ) AND  ((qryStockValuationForStocktake.StoreID)=#lngStoreID#) AND ((qryStockValuationForStocktake.DeptNo)=#lngDeptNo#)) ">
		<cfset strQuery = strQuery & "ORDER BY qryStockValuationForStocktake.Description">
		
		<!--- <cfoutput><br>#strQuery#</cfoutput> --->
		<CFQUERY name="GetRecord"      datasource="#application.dsn#"        > <!--- <CFQUERY name="GetRecord"      dataSource="#AppCostiDB1#"       USERNAME="admin"> --->
			#PreserveSingleQuotes(strQuery)#
		</CFQUERY>
        <cfoutput>
...
<!---             <td><div align="right"><h4>#numberformat(GetRecord.QtyOnHand,"_____.00")#&nbsp;</h4></div></td>			
 --->			<td>
				<div align="center"><input type="text" name="Dept_#lngGlobalDepartment#_Value_Line_#lngGlobalRecordNumber#" maxlength="10" size = "10" value="#numberformat(GetRecord.Wastage,"______.000")#"></div></font>
		        <input type="hidden" name="Dept_#lngGlobalDepartment#_Value_Line_#lngGlobalRecordNumber#_required" value="Please type Wastage on line #lngGlobalRecordNumber# of department #lngGlobalDepartment#">
		        <input type="hidden" name="Dept_#lngGlobalDepartment#_Value_Line_#lngGlobalRecordNumber#_float" value="Please type Wastage on line #lngGlobalRecordNumber# of department #lngGlobalDepartment#">
				<!--- 		        
...
<!--- 	
      <td>
        <input type="submit" name="btnEdit_OK" value="  SAVE - Enter More later ">
      </td>
 --->	  
      <td> 
        <div align="center">
          <input type="submit" name="btnApply_OK" value="  Save Entries ">
        </div>
      </td>
    </tr>
  </table>
