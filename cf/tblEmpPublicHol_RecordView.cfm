...
<cfset strPageTitle = "Public Holiday View">
...
<!--- <CF_FormatDateString Value="02032005">
<cfoutput>#strFormattedDate#</cfoutput>
 --->
...
FROM tblEmpPublicHol;
 --->
<!--- <cfset strQuery = "SELECT tblEmpPublicHol.PublicHolID, tblEmpPublicHol.Date, tblEmpPublicHol.Name, tblEmpPublicHol.DateEntered, tblEmpPublicHol.PublicHolID AS ID_Field ">
 --->
<cfset strQuery = "SELECT tblEmpPublicHol.PublicHolID, tblEmpPublicHol.PublicHolID AS ID_Field, ">
<cfset strQuery = strQuery & "case when Trading = 0 then 'No' else 'Yes' end AS ShopIsOpen, * ">
<cfset strQuery = strQuery & "FROM tblEmpPublicHol ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblEmpPublicHol.PublicHolID = #URL.RecordID#">
</CFIF>
...
<table width="100%" border="0">
  <tr>
    <td>
	  ...
	  <cfoutput>
<FORM action="tblEmpPublicHol_RecordAction.cfm" method="post">
...
<!---           <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" >
 --->
            <TR> 
              ...
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.PublicHolID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Date:</h2></TD>
              <TD width="300"> 
					<CF_FormatDateString Value=#GetRecord.Date#>
                	<div align="left"><h2>#strFormattedDate#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Name:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Name#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Trading:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.ShopIsOpen#</h2></div>
              </TD>
            </TR>
            <TR> 
