...
<link rel="stylesheet" type="text/css" href="costi.css">
	<TITLE>Stock Location Integrity</TITLE>
...
<table width="100%">
  <tr valign="middle"> 
    <td width="25%"><a href="MainMenu.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('home','','../images/butHomeDown.gif',1)" target="_top"><img name="home" border="0" src="../images/butHomeUp.gif" width="114" height="34" align="top"></a></td>
 	<td> 
      <h1>Stock Location Integrity</h1>
    </td>
    <td width="25%"> 
  ...
  <tr>
    <td>
      <div align="center">
		...
		<CFQUERY name="GetTheStores" datasource="#application.dsn#" > 
			Select * from tblStores
		</CFQUERY>
		<cfloop query = "GetTheStores">
			<cfset lngStoreID = #GetTheStores.StoreID#>
			<cfoutput><BR><h3>Testing items belonging to store #lngStoreID#</h3></cfoutput>
		...
		<hr>
		<cfoutput><BR><h2>All stock master items exist in the stock location table.</h2></cfoutput>
