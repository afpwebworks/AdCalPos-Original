...
<cfset strQuery = "SELECT CONVERT(int, SUBSTRING(StartDate, 5, 4)+ SUBSTRING(StartDate, 3, 2) + SUBSTRING(StartDate, 1, 2)) AS lngDate, TaxPaidID, StoreID, ReferenceNumber, StartDate, EndDate, TaxAmount ">
<cfset strQuery = strQuery & "FROM tblEmpTaxPaid ">
...
<TR bgcolor="#IIf(CurrentRow Mod 2, DE('00006D'), DE('0033FF'))#">
	<TD width="100"  align="center"><a href="HistorySelectionTaxDetail.cfm?FD=#lngFD#&TD=#lngTD#&RD=#SearchResult.TaxPaidID#&SID=#lngStoreID#"><h3>#SearchResult.TaxPaidID#</h3></a></TD>
	...
	<TD width="100"  align="right">#NumberFormat(SearchResult.TaxAmount,"______.00")#&nbsp;</TD>
</TR>
</CFOUTPUT>
</TABLE>
	  </div>
