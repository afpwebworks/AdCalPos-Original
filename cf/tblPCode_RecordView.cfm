...
<cfset strPageTitle = "PCode Description View">
...
<cfset strQuery = "SELECT PCodeID, PCodeDescription, DateEntered, PCodeID AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblPCodes ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE PCodeID = #URL.RecordID#">
</CFIF>
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              ...
              <TD width="250"> 
                <div align="left"><h2>#PCodeID#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>PCode Description:</h2></TD>
              <TD width="250"> 
                <div align="left"><h2>#PCodeDescription#</h2></div>
              </TD>
            </TR>
