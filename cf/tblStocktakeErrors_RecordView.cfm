...
<cfset strPageTitle = "Stock Adjustment Reason Code View">
...
<!---           <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" >
 --->
            <TR> 
              <TD valign="top" width="150"><h2>Error ID:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.ErrorID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Error Desc:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.ErrorDesc#</h2></div>
              </TD>
            </TR>
