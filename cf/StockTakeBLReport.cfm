...
<table width="100%">
  <tr valign="middle"> 
    ...
    <td width="25%"> 
      <div align="right"><a href="StockTakeSelectionBL.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
    </td>
  </tr>
  <tr> 
 	<td colspan="3"> 
...
<table width="100%" border="0">
  <tr>
    <td>
      <div align="center">&nbsp; 
        ...
        <input type="hidden" name="lngemployeeID" value="#session.employeeID#">
  ...
  <cfoutput query = "GetRecord">
          ...
          <tr> 
			...
			<td>
				<div align="center">#GetRecord.Freezer_QtyOnHand#</div>
			</td>
			<td>
				<div align="center">#GetRecord.CoolRoom_QtyOnHand#</div>
			</td>
			<td>
				<div align="center">#GetRecord.Display_QtyOnHand#</div>
			</td>
          </tr>
  </cfoutput>
