...
<cfset strPageTitle = "Change Costs">
...
<cfset strQuery = strQuery & "WHERE (((tblStockMaster.SuppressOrder)=0) AND ((tblStockMaster.NoLongerUsed)=0) AND ((tblStockMaster.PluType)='N') ) ">
...
<cfset strQuery = strQuery & "ORDER BY tblStockDept.DeptNo">
 --->
<cfset strQuery = "SELECT * from tblStockDept order by DeptNo">
  ...
  <tr>
    <td>
      <div align="center">
		...
		<FORM action="CostList.cfm" method="post">
			<select name="cmbDeptNo">
    	      ...
    	      &nbsp; 
        <p>
          <input type="submit" name="Submit" value="Change Cost">
        </p>
		</form>
      </div>
    </td>
...
<table ALIGN="CENTER" width="700" border="0">
  <tr>
    <td><div align="center">
		<h2>The cost change can only be done by one person at a time. </h2>
    </td>
  </tr>
 ...
 <tr>
    <td><div align="center">
		<h2>Unpredictable results will occur if two or more people try to change the costs at the same time.</h2>
    </td>
  </tr>

</table>

<!--- <p align="center"><h2>Please note that the cost change needs to be done by only one person at a time. </h2></p>
<p align="center"><h2>If two or more people try to change the costs at the same time</h2></p>
<p align="center"><h2>then the result will not be accurate.</h2></p>
