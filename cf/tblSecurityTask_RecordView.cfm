...
<cfset strPageTitle = "Security Task View">
...
<cfset strQuery = "SELECT tblSecurityTask.TaskID, tblSecurityUserTypes.UserType, tblSecurityTaskForms.TaskName, tblSecurityTask.DateEntered, tblSecurityTask.TaskID AS ID_Field ">
...
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblSecurityTask.TaskID = #URL.RecordID# ">
</CFIF>
<cfset strQuery = strQuery & "ORDER BY tblSecurityUserTypes.UserTypeID, tblSecurityTaskForms.HeadingOrder, tblSecurityTaskForms.FormOrder">
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              <TD valign="top" width="150"><h2>Task ID:</h2></TD>
              <TD width="250"> 
                <div align="left"><h2>#GetRecord.TaskID#</h2></div>
              </TD>
            </TR>
            <TR> 
            ...
            <TR> 
              <TD valign="top" width="150"><h2>Task Name:</h2></TD>
              <TD width="250"> 
