...
<cfset strPageTitle = "Expense Category View">
...
<cfset strQuery = "SELECT tblSupExpenseCat.ExpenseCatID, tblSupExpenseCat.ExpenseCat, tblSupExpenseCat.DateEntered, tblSupExpenseCat.ExpenseCatID AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblSupExpenseCat ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblSupExpenseCat.ExpenseCatID = #URL.RecordID#">
</CFIF>
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              ...
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.ExpenseCatID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Category:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.ExpenseCat#</h2></div>
              </TD>
            </TR>
