...
<cfset local.page="PayrollSelectReportSuper.cfm">

<cfset strPageTitle = "Pay Super">
...
<br>
<br>
<FORM action="PayrollSelectReportActionSuper.cfm" id="<cfoutput>#local.formName#</cfoutput>" method="post" name="<cfoutput>#local.formName#</cfoutput>" onsubmit="return submitCheck('<cfoutput>#local.formName#</cfoutput>');">
  ...
  <tr>
    <td>
      <div align="center">
	    ...
	    <p><input type="submit" name="AmountToPay" value=" See Super Summary  "></p>
	  <p>&nbsp;</p>
	  </form>
	  </div>
    </td>
