...
<FORM action="PackingActionB.cfm" method="post">
...
<p></P>
	<input type="submit" name="frozen" id="frozen" value=" Show Early Order " >
	<input type="submit" name="notFrozen" id="notFrozen" value=" Show Main Order ">
</Form>
