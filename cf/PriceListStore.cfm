...
<cfset strPageTitle = "Availability Price List">
...
<!--- <CFQUERY  name="GetComment" DBTYPE="OLEDB" PROVIDER="#AppProvider#" dataSource="#AppCostiDB1#" PROVIDERDSN="#AppCostiDB1#" USERNAME="admin"> --->
			#PreserveSingleQuotes(strQuery)#
</CFQUERY>
...
<!---       <div align="right"><a href="PriceListSelection.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div> --->
      <div align="right"><a href="PriceListSelectionStore.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
    </td>
  </tr>
</table>
<br>
...
<cfoutput>
          <tr><td colspan="11"><h2>Highlighted Items get more than the minimum Gross Profit</h2></td></tr>
</cfoutput>
  ...
  <CFLOOP QUERY="GetDepartments"> 
    <cfset lngDeptNo = #GetDepartments.DeptNo# >
	   <cfoutput>
		...
		<cfset strQuery = strQuery & "FROM (tblStockGroup INNER JOIN tblStockMaster ON tblStockGroup.GroupNo = tblStockMaster.GroupNo) INNER JOIN tblStockDept ON tblStockGroup.DeptNo = tblStockDept.DeptNo ">
		<cfset strQuery = strQuery & "WHERE (((tblStockDept.DeptNo)=#lngDeptNo#) AND ((tblStockMaster.SuppressOrder)=0) AND ((tblStockMaster.NoLongerUsed)=0) AND ((tblStockMaster.PluType)<>'M') AND ((tblStockMaster.PluType)<>'P') ) ">
  ...
  <cfoutput query = "GetRecord">
  			<cfif GetRecord.MaxRetail NEQ "0">
          ...
          <tr> 
			...
			<td bgcolor=#color#><div align="right"><h4>#numberformat(GP,"_____.00")#&nbsp;</h4></div></td>
			<cfelse>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			</cfif>
