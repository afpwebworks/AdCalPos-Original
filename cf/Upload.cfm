...
<cfset strPageTitle = "Upload Picture File">
...
<table width="100%" border="0">
  <tr>
    <td>
      <div align="center"> 
        <h3>
			<p>Please select a picture file (*.jpg, *.gif) to upload</p>
    	    <p>For maximum clarity, the picture file should ideally be 240 (Width) X 200 (Height) 
        	  Pixels<br> </p>
	        <p>Please note that, the lower the resolution of the picture file, the faster it loads.</p>
		</h3>  
		<p>&nbsp;</p>
    	    <form Action ="Uploadfile.cfm" method = "Post" enctype="multipart/form-data">
	        	<font color="FFFFFF" size="3"><b>File:</b></font> 
				<Input Type = "File" Name = "MyFile" size="100">
				<Br>
  				<br>&nbsp;
	        	<Input type ="Submit" value="Send Picture Now">
			</form>
	  </div>
    </td>
  </tr>
