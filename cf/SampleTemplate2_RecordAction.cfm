...
<CFIF 
	...
	<CFIF GetRecord.RecordCount is 1>
		<CFLOCATION url="SampleTemplate2_RecordView.cfm?RecordID=#GetRecord.ID_Field#">
	<CFELSE>
		<CFLOCATION url="SampleTemplate2_RecordView.cfm?RecordID=#Form.RecordID#">
	</CFIF>
...
<CFELSEIF ParameterExists(Form.btnView_Edit)>
	...
	<CFLOCATION url="SampleTemplate2_RecordEdit.cfm?RecordID=#Form.RecordID#">
...
<CFELSEIF ParameterExists(Form.btnView_Add)>
	...
	<CFLOCATION url="SampleTemplate2_RecordEdit.cfm">
...
<CFELSEIF ParameterExists(Form.btnView_Delete)>
	...
	<CFLOCATION url="SampleTemplate2_RecordView.cfm">
...
<CFELSEIF ParameterExists(Form.btnEdit_OK)>
	...
	<CFELSE>
		...
		<CFLOCATION url="SampleTemplate2_RecordView.cfm?RecordID=#GetNewRecord.ID_Field#">
