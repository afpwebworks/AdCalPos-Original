...
<!--- <CFQUERY  DBTYPE="OLEDB" PROVIDER="#AppProvider#" dataSource="#AppCostiDB1#" PROVIDERDSN="#AppCostiDB1#" USERNAME="admin" name="GetUserTypeCombo"> --->
	SELECT tblSecurityUserTypes.UserTypeID, tblSecurityUserTypes.UserType
	FROM tblSecurityUserTypes
	WHERE (((tblSecurityUserTypes.UserTypeID)<>1))	
...
<!--- <CFQUERY  DBTYPE="OLEDB" PROVIDER="#AppProvider#" dataSource="#AppCostiDB1#" PROVIDERDSN="#AppCostiDB1#" USERNAME="admin" name="GetStoreCombo"> --->
	SELECT tblStores.StoreID, tblStores.StoreName
	FROM tblStores
            ...
            <TABLE width="960" border="1" cellpadding="0">
              <TR> 
				...
				<td>
	             <CFIF not ParameterExists(URL.RecordID)>
	                  <INPUT type="text" name="EmployeeID" value="#EmployeeID_Value#" size="30" maxLength="4">
        	      <cfelse>
            	       #EmployeeID_Value# 
				  </CFIF>
 					<!--- field validation --->
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Surname: </font> </TD>
                <TD> 
                  <INPUT type="text" name="Surname" value="#Surname_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> Birthday </td>
                 <td width="130">
                  <INPUT type="text" name="BirthDay" value="#BirthDay_Value#" size="30" maxLength="21">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Given Name: </font> </TD>
                <TD> 
                  <INPUT type="text" name="GivenName" value="#GivenName_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> Hourly </td>
                 <td width="130">
                  <INPUT type="text" name="HourlyPayRate" value="#HourlyPayRate_Value#" size="30" maxLength="10">
 					<!--- field validation --->
					<INPUT type="hidden" name="HourlyPayRate_integer">
				 </td>
              </TR>
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Taxfile No: </font> </TD>
                <TD> 
                  <INPUT type="text" name="TaxFileNo" value="#TaxFileNo_Value#" size="30" maxLength="21">
                </TD>
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Street: </font> </TD>
                <TD> 
                  <INPUT type="text" name="Street" value="#Street_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> Commenced </td>
                 <td width="130">
                  <INPUT type="text" name="Commenced" value="#Commenced_Value#" size="30" maxLength="21">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Address 1: </font> </TD>
                <TD> 
                  <INPUT type="text" name="Address1" value="#Address1_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> Finished </td>
                 <td width="130">
                  <INPUT type="text" name="Finished" value="#Finished_Value#" size="30" maxLength="21">
				 </td>
              </TR>
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Address 2: </font> </TD>
                <TD> 
                  <INPUT type="text" name="Address2" value="#Address2_Value#" size="30" maxLength="21">				
                </TD>
				<td width="110"> Leave Available </td>
                 <td width="130">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Postcode: </font> </TD>
                <TD> 
                  <INPUT type="text" name="PostCode" value="#PostCode_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> Leave Taken </td>
                 <td width="130">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  State: </font> </TD>
                <TD> 
                  <INPUT type="text" name="State" value="#State_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> Sick Available </td>
                 <td width="130">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Phone: </font> </TD>
                <TD> 
                  <INPUT type="text" name="Phone" value="#Phone_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> Sick Taken </td>
                 <td width="130">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Fax: </font> </TD>
                <TD> 
                   <INPUT type="text" name="Fax" value="#Fax_Value#" size="30" maxLength="21"> 
                </TD>
				<td width="110"> YTD Gross </td>
                 <td width="130">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Mobile: </font> </TD>
                <TD> 
                  <INPUT type="text" name="Mobile" value="#Mobile_Value#" size="30" maxLength="21">
                </TD>
				<td width="110"> YTD Tax </td>
                 <td width="130">
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                  Email: </font> </TD>
                <TD> 
                  <INPUT type="text" name="Email" value="#Email_Value#" size="30" maxLength="100">
                </TD>
				<td width="110"> YTD Net </td>
                 <td width="130">
                  <INPUT type="text" name="ytdNetPay" value="#ytdNetPay_Value#" size="30" maxLength="10">
				 </td>
			  <TD width="130"> User Name &nbsp;</td>
			  <TD width="130">
			  	<INPUT TYPE="text" name="UserName" value="#UserName_Value#" size=20 maxlength="20"></td>
              </TR>
              ...
              <TR> 
                <TD valign="top" width="150"> <font face="Tahoma" color="FFFFFF"> 
                 &nbsp; </font> </TD>
                <TD>&nbsp;   </TD>
				<td width="110"> YTD Super </td>
                 <td width="130">
                  <INPUT type="text" name="ytdSuper" value="#ytdSuper_Value#" size="30" maxLength="10">
				 </td>
			  <TD width="130"> Password &nbsp;</td>
			  <TD width="130">
			  	<INPUT TYPE="text" name="Password" value="#Password_Value#" size=20 maxlength="20"></td>
              </TR>
