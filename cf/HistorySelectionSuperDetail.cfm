...
<!--- Get the records --->
<cfset strQuery = "SELECT CONVERT(int, SUBSTRING(WeekEnding, 5, 4)+ SUBSTRING(WeekEnding, 3, 2) + SUBSTRING(WeekEnding, 1, 2)) AS lngDate, * from tblEmpPayRollPaid where SuperPaidID = #lngRecordID# ">
...
<table width="100%">
  <tr valign="middle"> 
    ...
    <td width="25%"> 
	  <cfoutput>
      <div align="right"><a href="HistorySelectionSuper.cfm?FD=#lngFD#&TD=#lngTD#&SID=#lngStoreID#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('backImage','','../images/butBackDown.gif',1)"><img name="backImage" border="0" src="../images/butBackUp.gif" width="115" height="34"></a></div>
	  </cfoutput>	
    </td>
  </tr>
</table>
...
<CFOUTPUT query="GetDetail">
	<cfset dblTotal = dblTotal + #GetDetail.SuperAccumulated# >
<TR bgcolor="#IIf(CurrentRow Mod 2, DE('00006D'), DE('0033FF'))#">
	...
	<TD width="100"  align="right">#NumberFormat(GetDetail.SuperAccumulated,"______.00")#&nbsp;</TD>
</TR>
</CFOUTPUT>
<cfoutput>
<TR>
