...
<cfset strPageTitle = "Package Unit Types View">
...
<cfset strQuery = "SELECT tblStockUnitType.UnitTypeID, tblStockUnitType.UnitType, tblStockUnitType.DateEntered, tblStockUnitType.UnitTypeID AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblStockUnitType ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblStockUnitType.UnitTypeID = #URL.RecordID#">
</CFIF>
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              ...
              <TD width="250"> 
                <div align="left"><h2>#GetRecord.UnitTypeID#</h2></div>
              </TD>
            </TR>

            <TR> 
              <TD valign="top" width="150"><h2>Unit Type:</h2></TD>
              <TD width="250"> 
                <div align="left"><h2>#GetRecord.UnitType#</h2></div>
              </TD>
            </TR>
