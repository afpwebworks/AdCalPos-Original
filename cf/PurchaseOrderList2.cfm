...
<!--- 	    <td width="117" bgcolor="3366FF"><font size="2" face="Tahoma"> 
 ...
 --->	    <td width="117" bgcolor="000099"><font size="2" face="Tahoma"> 
          <div align="center">#GetRecord.PartNo#</div>
          </font></td>
    	<td width="163"><font size="2" face="Tahoma"><b>#GetRecord.Description#</b></font></td>
	    <td width="35"><font size="2" face="Tahoma">
...
<!--- 
 ...
 --->
    	...
    	<td width="153"><font size="2" face="Tahoma">
