...
<cfset local.page="PayrollSelectReportPaySlip.cfm">
...
<br>
<br>
<FORM action="PayrollSelectReportActionPaySlip.cfm" id="<cfoutput>#local.formName#</cfoutput>" method="post" name="<cfoutput>#local.formName#</cfoutput>" onsubmit="return submitCheck('<cfoutput>#local.formName#</cfoutput>');">
  ...
  <tr>
    <td>
      <div align="center">
	    ...
	    <p><input type="submit" name="AmountToPay" value=" Employee Pay Summary "></p>
	  <p>&nbsp;</p>
	  </form>
	  </div>
    </td>
