<cfset strPageTitle = "Product List">
<CFQUERY name="GetRecord" datasource="#application.dsn#" > 
       SELECT tblStockMaster.PartNo,  tblStockMaster.productid AS ID_Field, * 
       FROM tblStockMaster 
       <cfif structKeyExists(URL, "GID")>
          WHERE GroupNo = #URL.GID#
       </cfif>   
...
<table width="100%" border="0">
  <FORM action="tblStockMaster_RecordAction.cfm" method="post">
    <tr>
      <td align="center"><INPUT type="submit" name="btnView_Add" value="   Add    "></td>
    </tr>
  </FORM>
  <tr>
    <td><div align="center">
