...
<CFSET FormFieldList = "BundyNo,StoreID,GivenName,Surname,TaxFileNo,Street,Address1,Address2,PostCode,State,Phone,Fax,Mobile,Email,BirthDay,EmpStatusID,HourlyPayRate,MonthlySalary,Commenced,Finished,entLeaveAvail,entLeaveTaken,entSickAvail,entSickTaken,ytdGross,ytdTax,ytdNetPay,ytdSuper,NoLongerUsed,UserType,UserName,Password">
...
<CFIF ParameterExists(URL.RecordID)>
    <CFQUERY  DBTYPE="OLEDB" DBNAME ="CostiSQL" DBSERVER="w2000s" PROVIDER="SQLOLEDB" dataSource="CostiSQL" PROVIDERDSN="CostiSQL" USERNAME="sa" PASSWORD="" name="GetRecord" maxRows=1>
		SELECT tblEmployee.EmployeeID, tblEmployee.BundyNo, tblEmployee.StoreID, tblEmployee.GivenName, tblEmployee.Surname, tblEmployee.TaxFileNo, tblEmployee.Street, tblEmployee.Address1, tblEmployee.Address2, tblEmployee.PostCode, tblEmployee.State, tblEmployee.Phone, tblEmployee.Fax, tblEmployee.Mobile, tblEmployee.Email, tblEmployee.BirthDay, tblEmployee.EmpStatusID, tblEmployee.HourlyPayRate, tblEmployee.MonthlySalary, tblEmployee.Commenced, tblEmployee.Finished, tblEmployee.entLeaveAvail, tblEmployee.entLeaveTaken, tblEmployee.entSickAvail, tblEmployee.entSickTaken, tblEmployee.ytdGross, tblEmployee.ytdTax, tblEmployee.ytdNetPay, tblEmployee.ytdSuper, tblEmployee.NoLongerUsed, tblEmployee.UserType, tblEmployee.UserName, tblEmployee.Password, tblEmployee.EmployeeID AS ID_Field
		FROM tblEmployee
		<CFIF ParameterExists(URL.RecordID)>
...
<HTML><HEAD>
	<TITLE>TestSQL - Edit Record</TITLE>
...
<TABLE>
    ...
    <TD>
		...
		<INPUT type="text" name="EmployeeID" value="#EmployeeID_Value#" maxLength="4">
...
<!--- 	<INPUT type="hidden" name="StoreID_integer"> --->
    ...
    <TD>
		...
		<INPUT type="text" name="UserType" value="#UserType_Value#" maxLength="30">
