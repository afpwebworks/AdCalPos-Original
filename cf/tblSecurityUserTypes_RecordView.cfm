...
<cfset strPageTitle = "User Type View">
...
<cfset strQuery = "SELECT tblSecurityUserTypes.UserTypeID, tblSecurityUserTypes.UserType, tblSecurityUserTypes.DateEntered, tblSecurityUserTypes.UserTypeID AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblSecurityUserTypes ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblSecurityUserTypes.UserTypeID = #URL.RecordID#">
</CFIF>
...
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->
            ...
            <TR> 
              <TD valign="top" width="150"><h2>UserTypeID:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.UserTypeID#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>User Type</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.UserType#</h2></div>
              </TD>
            </TR>
            <TR> 
