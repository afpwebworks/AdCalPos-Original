...
<cfset strPageTitle = "Department File">
      ...
      <table id="id2" class="tablesorter">
        ...
        <tbody>
        	<cfloop query="getrecord"><cfoutput>
            	<tr>
                	<td><a href="tblStockDept_RecordActionGrid.cfm?cfgridkey=#getrecord.deptno#">#getrecord.deptno#</a></td>
                	<td>#getrecord.Dept#</td>
                	<td>#getrecord.backGroundColor#</td>
                	<td>#getrecord.ImageFileName#</td>
                </tr>
            </cfoutput></cfloop>
        </tbody>
      </table>
