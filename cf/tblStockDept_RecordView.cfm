...
<cfset strPageTitle = "Department View">
...
<cfset strQuery = "SELECT tblStockDept.DeptNo , tblStockDept.Dept , tblStockDept.backGroundColor ,tblStockDept.ImageFileName , tblStockDept.DateEntered , tblStockDept.DeptNo AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblStockDept ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblStockDept.DeptNo = #URL.RecordID#">
</CFIF>
...
<CFOUTPUT query="GetRecord">
          <TABLE border="1" width="450" cellpadding="2">
            <TR> 
              <TD valign="top" width="150"><h2>Dept No:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.DeptNo# </h2><a href="tblStockGroup_RecordList.cfm?DID=#GetRecord.DeptNo#"><font color="FFFF00" face="Tahoma" size="3">Show Groups</font></a></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Department:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Dept#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Background:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.BackgroundColor# &nbsp;</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="150"><h2>Image File:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.ImageFileName# &nbsp;</h2></div>
              </TD>
            </TR>
            <TR> 
