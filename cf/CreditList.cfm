...
<table width="100%" border="0">
  <tr>
	...
	<cfset strQuery = strQuery & "WHERE (((tbCreditDetail.Status)='Credit Request')) ">
	<cfset strQuery = strQuery & "ORDER BY tbCreditDetail.CreditDetID">
...
<table width="100%" border="1" cellspacing="0">
  <tr> 
    <td width="50"><b><font size="2">Approve Reject</font></b></td>
  ...
  <tr> 
    <td width="50"><div align="center"><a href="CreditView.cfm?ID=#GetLines.CreditDetID#"><font color="FFFFFF" size="2">#GetLines.CreditDetID#</font></a>&nbsp;</div></td>
