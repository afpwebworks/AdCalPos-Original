...
<table width="65%" border="0">
  ...
  <CFLOOP QUERY="GetDepartments"> 
    ...
    <cfset lngDeptNo = #GetDepartments.DeptNo# >
		...
		<cfset strQuery = strQuery & "AND ((qryStockValuationForStocktake.Wastage) > 0)) ">
...
<!---             <td><div align="center"><h4>On Hand</h4></div></td>
 --->
...
<!---             <td><div align="right"><h4>#numberformat(GetRecord.QtyOnHand,"_____.00")#&nbsp;</h4></div></td>			
 --->			<td>
				<div align="right">#NumberFormat(GetRecord.Wastage,"_____.000")#&nbsp;</div></font>
