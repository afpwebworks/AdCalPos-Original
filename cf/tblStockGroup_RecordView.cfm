...
<cfset strPageTitle = "Product Groups View">
...
<cfset strQuery = "SELECT tblStockGroup.GroupNo, tblStockGroup.[Group], tblStockGroup.DeptNo, tblStockGroup.DateEntered, tblStockDept.Dept, tblStockGroup.GroupNo AS ID_Field ">
<cfset strQuery = strQuery & "FROM tblStockDept INNER JOIN tblStockGroup ON tblStockDept.DeptNo = tblStockGroup.DeptNo ">
<CFIF ParameterExists(URL.RecordID)>
	<cfset strQuery = strQuery & "WHERE tblStockGroup.GroupNo = #URL.RecordID#">
</CFIF>
...
<CFOUTPUT query="GetRecord">
          <TABLE border="1" width="470" cellpadding="2">
<!---          <TABLE border="1" bordercolor="FFFFFF" width="450" cellspacing="0" > --->

            <TR> 
              <TD valign="top" width="170"><h2>Group No:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.GroupNo#</h2><a href="tblStockMaster_RecordList.cfm?GID=#GetRecord.GroupNo#"><font color="FFFF00" face="Tahoma" size="3">Show PLU</font></a></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="170"><h2>Product Group:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Group#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="170"><h2>Department No:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.DeptNo#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="170"><h2>Department:</h2></TD>
              <TD width="300"> 
                <div align="left"><h2>#GetRecord.Dept#</h2></div>
              </TD>
            </TR>
            <TR> 
              <TD valign="top" width="170"><h2>Date Entered:</h2></TD>
              <TD width="300"> 
